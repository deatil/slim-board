...
class __TwigTemplate_9ee5dcfe71fbb9a6f639f427b588a8b4 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 4
        if ($this->env->getRuntime('App\Twig\TwigRuntimeExtension')->isLogin()) {
            // line 5
            echo "    ";
    ...
    ";
            // line 10
            if (($this->env->getRuntime('App\Twig\TwigRuntimeExtension')->isAdmin() == 1)) {
                // line 11
                echo "        <a href=\"";

...
class __TwigTemplate_93662576dcfdfeaad1c00c3cadedefc1 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_script($context, array $blocks = [])
    {
        ...
        // line 44
        echo "        <script src='";
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/core/jquery.3.2.1.min.js"), "html", null, true);
        echo "'></script>
        <script src='";
        // line 45
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/core/popper.min.js"), "html", null, true);
        echo "'></script>
        <script src='";
        // line 46
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/core/bootstrap.min.js"), "html", null, true);
        echo "'></script>
        
        <script src='";
        // line 48
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"), "html", null, true);
        echo "'></script>
        <script src='";
        // line 49
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"), "html", null, true);
        echo "'></script>

        <!-- jQuery Scrollbar -->
        <script src='";
        // line 52
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"), "html", null, true);
        echo "'></script>
        ...
        <script src='";
        // line 56
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/ready.js"), "html", null, true);
        echo "'></script>
        <script src='";
        // line 57
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/layer/layer.js"), "html", null, true);
        echo "' type=\"text/javascript\"></script>
        
        <script src='";
        // line 59
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->adminAssets("js/setting.js"), "html", null, true);
        echo "'></script>

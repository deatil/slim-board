...
/* board/timi/auth/login.html */
class __TwigTemplate_ae106a6432bd855cbf7107e47273d25c extends Template
{
    private $source;
    private $macros = [];
...
<body>
    ...
    <script src='";
        // line 60
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->boardAssets("js/jquery-3.4.1.min.js"), "html", null, true);
        echo "' type=\"text/javascript\"></script>
    <script src='";
        // line 61
        echo twig_escape_filter($this->env, $this->env->getRuntime('App\Board\Twig\TwigRuntimeExtension')->boardAssets("js/layer/layer.js"), "html", null, true);
        echo "' type=\"text/javascript\"></script>
...
";
    ...
    {
        return "board/timi/auth/login.html";
    }
    ...
    {
        return new Source("", "board/timi/auth/login.html", "D:\\app\\workroom\\php\\project\\slim-board\\data\\views\\board\\timi\\auth\\login.html");
    }
}
